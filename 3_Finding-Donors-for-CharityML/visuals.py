...
def evaluate(results, accuracy, f1):
    ...
    for k, learner in enumerate(['LogisticRegression', 'AdaBoostClassifier', 'RandomForestClassifier']):
    ...
    patches = []
    for i, learner in enumerate(['LogisticRegression', 'AdaBoostClassifier', 'RandomForestClassifier']):
